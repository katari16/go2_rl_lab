...
for ax, (label, gt_key, est_key, unit, gt_color) in zip(axes, channels):
    ...
    ax.plot(t, np.array(d_j5[est_key])[mask], color=COLOR_J5, linewidth=1.8, alpha=0.9)
...
out = os.path.join(os.path.dirname(J5_PATH), "..", "p1_vs_j5_comparison.png")
