"""
Sim2Sim deployment: Run trained IsaacLab proprioceptive policy in unitree_mujoco
with full FSM (matching deploy_real) and keyboard + joystick control.

Usage:
  1. Start unitree_mujoco:  cd ~/unitree_mujoco/simulate_python && python3 unitree_mujoco.py
  2. Run this script:       cd ~/sim_to_real_go2/sim2sim && python3 sim2sim_deploy.py
...
if __name__ == "__main__":
    ...
    cfg = load_config(project_root / "deploy_real" / "configs" / "go2_isaaclab.yaml")
    ...
    try:
        while not should_stop:
            ...
            # ── Build observation (45-dim proprioceptive) ─────────────
            ...
            # obs[9:21] = joint_pos - default_joint (Isaac convention)
