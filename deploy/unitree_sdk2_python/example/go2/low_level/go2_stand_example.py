...
if __name__ == '__main__':
    ...
    while True:        
        if custom.percent_3 == 1.0:

            time.sleep(1)
            print("Saving data ...")
            time_data = torch.tensor(custom.time_buffer, dtype=torch.float32)
            ...
            print(f"File saved successfully! Collected {len(time_data)} steps.")
