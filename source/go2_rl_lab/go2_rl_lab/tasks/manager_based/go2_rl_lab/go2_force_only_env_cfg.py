...
@configclass
class CurriculumCfg:
    """No curriculum — force is fixed at 20N."""
    terrain_levels = None
...
@configclass
class UnitreeGo2ForceOnlyEnvCfg(ManagerBasedRLEnvCfg):
    """Go2 locomotion env with persistent XY forces for force-only estimation training."""
